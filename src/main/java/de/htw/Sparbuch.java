...
public class Sparbuch extends Konto {
	...
	*/
	...
	@Override
	protected boolean abhebenSpecific (double betrag){
	...
	public void waehrungswechsel(Waehrung w) {
		bereitsAbgehoben = (w.euroInWaehrungUmrechnen(this.getAktuelleWaehrung().waehrungInEuroUmrechnen(bereitsAbgehoben)));
